...
describe('SunburstComponent', () => {
  ...
  describe('Rendering', () => {
    it('should create an svg', fakeAsync(() => {
      fixture.detectChanges();
      tick();
    ...
    it('should handle changes to inputs', fakeAsync(() => {
      fixture.detectChanges();
      tick();
    ...
    it('should account for IE10-', fakeAsync(() => {
    ...
    it('should account for IE11', fakeAsync(() => {
    ...
    it('should account for Edge', fakeAsync(() => {
    ...
    it('should rebuild when it becomes visible', fakeAsync(() => {
    ...
    it('should handle minPathLength', fakeAsync(() => {
    ...
    it('should mouseover/mouseleave', fakeAsync(() => {
      fixture.detectChanges();
      tick();
  ...
  describe('Selection', () => {
    it('should output selected and path', fakeAsync(() => {
      spyOn(component, 'select');
    ...
    it('should return to root on second click', fakeAsync(() => {
      spyOn(component, 'select');
      spyOn(component, 'path');
    ...
    it('should not go to root if already at root', fakeAsync(() => {
      spyOn(component, 'select');
    ...
    it('should work with no idField', fakeAsync(() => {
    ...
    it('should handle clicking invalid node', fakeAsync(() => {
      spyOn(component, 'select');
      component.idField = null;
      fixture.detectChanges();
      tick();
    ...
    it('should reselect selected id on rebuild', fakeAsync(() => {
      fixture.detectChanges();
      tick();
      TestUtility.altClickId(fixture, '-arc2');
      fixture.detectChanges();
    ...
    it('should select root id on rebuild if old id not found', fakeAsync(() => {
      fixture.detectChanges();
      tick();
      TestUtility.altClickId(fixture, '-arc2');
      fixture.detectChanges();
