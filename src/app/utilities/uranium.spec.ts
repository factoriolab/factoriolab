...
describe('UraniumUtility', () => {
  ...
  describe('calculateUranium238', () => {
    it('should skip if no u238 required', () => {
      const step = { u238: { items: new Fraction(0) } };
      UraniumUtility.calculateUranium238(step as any, matrix);
      expect(step.u238.items.n).toEqual(0);
    });
  ...
  describe('calculateUranium235', () => {
    it('should skip if no u235 required', () => {
      const step = { u235: { items: new Fraction(0) } };
      UraniumUtility.calculateUranium235(step as any, matrix);
      expect(step.u235.items.n).toEqual(0);
    });
  ...
  describe('calculateItems', () => {
    it('should calculate total items from factories', () => {
      ...
      UraniumUtility.calculateItems(step as any, matrix);
  ...
  describe('calculateInputs', () => {
    it('should calculate inputs for required factories', () => {
      const step = { u238: { factories: new Fraction(1) } };
      const steps = [];
  ...
  describe('calculateFactories', () => {
    it('should calculate factories based on speed factors', () => {
      ...
      UraniumUtility.calculateFactories(
        step as any,
        matrix,
        mocks.RecipeFactors
      );
