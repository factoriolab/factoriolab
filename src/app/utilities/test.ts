...
export class TestUtility {
  static getId(fixture: ComponentFixture<any>, id: Id) {
  ...
  static clickId(fixture: ComponentFixture<any>, id: Id) {
  ...
  static altClickId(fixture: ComponentFixture<any>, id: Id) {
    return this.altClick(this.getId(fixture, id));
  }

  static setTextId(fixture: ComponentFixture<any>, id: Id, value: string) {
  ...
  static selectId(fixture: ComponentFixture<any>, id: Id, value: string) {
  ...
  static dispatchId(fixture: ComponentFixture<any>, id: Id, event: string) {
