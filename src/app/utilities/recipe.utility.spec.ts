  ...
  describe('adjustRecipe', () => {
    it('should adjust a standard recipe', () => {
      ...
      const expected: AdjustedRecipe = {
        ...cloneRecipe(Mocks.RawDataset.recipeEntities[RecipeId.SteelChest]),
        ...{
    ...
    it('should handle recipes with declared outputs', () => {
      ...
      const expected: AdjustedRecipe = {
        ...cloneRecipe(Mocks.RawDataset.recipeEntities[RecipeId.CopperCable]),
        ...{
          time: Rational.from(2, 3),
          drain: Rational.from(5),
          consumption: Rational.from(150),
    ...
    it('should handle mining productivity', () => {
      ...
      const expected: AdjustedRecipe = {
        ...cloneRecipe(Mocks.RawDataset.recipeEntities[RecipeId.IronOre]),
        ...{
    ...
    //     data,
    //   );
    //   const expected = new Recipe(recipe);
    ...
    //   beforeEach(() => {
    //     recipeR = Mocks.Dataset.recipeIds.reduce((e: Entities<Recipe>, i) => {
