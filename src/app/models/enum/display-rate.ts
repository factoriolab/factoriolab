...
export const displayRateInfo: Record<DisplayRate, DisplayRateInfo> = {
  [DisplayRate.PerSecond]: {
    ...
    itemsLabel: 'options.amountType.itemsPerSecond',
    wagonsLabel: 'options.amountType.wagonsPerSecond',
    pollutionLabel: 'options.amountType.pollutionPerSecond',
  ...
  [DisplayRate.PerMinute]: {
    ...
    itemsLabel: 'options.amountType.itemsPerMinute',
    wagonsLabel: 'options.amountType.wagonsPerMinute',
    pollutionLabel: 'options.amountType.pollutionPerMinute',
    value: Rational.from(DisplayRate.PerMinute),
  },
  [DisplayRate.PerHour]: {
    option: DisplayRate.PerHour,
    suffix: 'options.displayRate.perHourSuffix',
    itemsLabel: 'options.amountType.itemsPerHour',
    wagonsLabel: 'options.amountType.wagonsPerHour',
    pollutionLabel: 'options.amountType.pollutionPerHour',
