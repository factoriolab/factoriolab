...
> = {
  [InserterTarget.Chest]: {
    [InserterCapacity.Capacity0]: [
      ...
      { id: ItemId.StackInserter, value: rational(4.62) },
    ],
    [InserterCapacity.Capacity2]: [
      ...
      { id: ItemId.StackInserter, value: rational(9.23) },
    ],
    [InserterCapacity.Capacity7]: [
      ...
      { id: ItemId.StackInserter, value: rational(27.69) },
    ],
  },
  [InserterTarget.ExpressTransportBelt]: {
    [InserterCapacity.Capacity0]: [
      ...
      { id: ItemId.LongHandedInserter, value: rational(1.2) },
      { id: ItemId.FastInserter, value: rational(2.31) },
      { id: ItemId.StackInserter, value: rational(4.44) },
    ],
    [InserterCapacity.Capacity2]: [
      ...
      { id: ItemId.StackInserter, value: rational(7.74) },
    ],
    [InserterCapacity.Capacity7]: [
      ...
      { id: ItemId.StackInserter, value: rational(13.85) },
    ],
  },
  [InserterTarget.FastTransportBelt]: {
    ...
    [InserterCapacity.Capacity2]: [
      ...
      { id: ItemId.LongHandedInserter, value: rational(2.35) },
      { id: ItemId.FastInserter, value: rational(4.44) },
      { id: ItemId.StackInserter, value: rational(7.06) },
    ],
    [InserterCapacity.Capacity7]: [
      ...
      { id: ItemId.StackInserter, value: rational(10.91) },
    ],
  },
  [InserterTarget.TransportBelt]: {
    ...
    [InserterCapacity.Capacity2]: [
      ...
      { id: ItemId.LongHandedInserter, value: rational(2.35) },
      { id: ItemId.FastInserter, value: rational(4.44) },
      { id: ItemId.StackInserter, value: rational(5.71) },
    ],
    [InserterCapacity.Capacity7]: [
      ...
      { id: ItemId.StackInserter, value: rational(6.79) },
    ],
  },
};
